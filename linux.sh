...
g++ build/vebview.o build/webview.o build/cJSON.o build/tinyfd.o $mbedtls_flags $(pkg-config --libs gtk+-3.0 webkit2gtk-4.0) -I "libs/tinyfd" -I "libs/webview" -I "$V_LOC/thirdparty/cJSON/" -o dist/vebview
